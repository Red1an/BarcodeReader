...
using static BarcodeReader.Controls.CameraView;

namespace BarcodeReader.Platforms.Windows
{
    public class CameraViewHandler : ViewHandler<CameraView, MediaPlayerElement>
    {
        ...
        private static void MapStopPreview(CameraViewHandler handler, CameraView view, object? arg3)
        {
            handler.StopPreview();
        }

        private static void MapStartPreview(CameraViewHandler handler, CameraView view, object? arg3)
        {
